...
-- 11 - Seguindo o conceito de paginação de resultados,
--      sabendo que cada página retorna apenas 10 resultados, faça a listagem dos registros que correspondam a página 4.
...
-- 16 - Selecione todos os campos da tabela musicas e os registros que o ritmo possua a última palavra igual a
--      troppo independente do restante do texto que antecede, mas que seja exatamente a última palavra do texto.

SELECT * FROM musicas WHERE ritmo like '%troppo';

-- 17 - Faça uma busca nos registros da tabela musicas e retorne somente os registros que possua em qualquer posição do texto,
--      da composição, a palavra quartet, independente de ser maiúscula ou minúscula.

SELECT * FROM musicas WHERE 
composicao ILIKE 'quartet%' OR 
composicao ILIKE '%quartet%' OR
composicao ILIKE '%quartet';

-- 18 - Faça uma busca nos registros da tabela musicas e retorne somente os registros
--      que não possua a palavra quintet na coluna composição, independente de ser maiúscula ou minúscula.